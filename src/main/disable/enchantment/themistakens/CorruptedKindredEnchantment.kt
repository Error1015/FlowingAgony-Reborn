...
object CorruptedKindredEnchantment : ModBaseEnchantment(
    ...
    override fun isTradableConfig(): Boolean = EnchantmentConfig.tradeableConfig.corruptedKindred.get()
    ...
    override fun isTreasureOnlyConfig(): Boolean = EnchantmentConfig.isTreasureConfig.corruptedKindred.get()
