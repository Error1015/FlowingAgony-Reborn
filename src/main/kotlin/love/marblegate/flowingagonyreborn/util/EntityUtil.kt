...
fun LivingEntity.isNeutral(restrictMode: Boolean): Boolean {
    val basicMobs = this is Bee || this is Dolphin || this is IronGolem || this is Wolf || this is Panda || this is PolarBear || this is Llama
    return if (restrictMode) {
        // 基础中立判断 + 额外类型
        basicMobs || this is EnderMan || this is Piglin || this is ZombifiedPiglin || this is Spider
    } else {
        // 基础中立生物类型判断
        basicMobs
    }
