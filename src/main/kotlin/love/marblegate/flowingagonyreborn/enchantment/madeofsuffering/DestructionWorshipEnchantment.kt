...
object DestructionWorshipEnchantment : ModBaseEnchantment(
    ...
    tradableSetting = EnchantmentConfig.tradableConfig.destructionWorship,
    discoverableSetting = EnchantmentConfig.discoverableConfig.destructionWorship,
    canApplyOnEnchantingTableSetting = EnchantmentConfig.applyOnEnchantingTableConfig.destructionWorship,
    isTreasureOnlySettings = EnchantmentConfig.isTreasureConfig.destructionWorship,
    canEnchantSetting = EnchantmentConfig.canEnchantConfig.destructionWorship,
    maxLevelValue = 1
) {
