...
object InsanePoetEnchantment : ModBaseEnchantment(
    ...
    tradableSetting = EnchantmentConfig.tradableConfig.insanePoet,
    discoverableSetting = EnchantmentConfig.discoverableConfig.insanePoet,
    canApplyOnEnchantingTableSetting = EnchantmentConfig.applyOnEnchantingTableConfig.insanePoet,
    isTreasureOnlySettings = EnchantmentConfig.isTreasureConfig.insanePoet,
    canEnchantSetting = EnchantmentConfig.canEnchantConfig.insanePoet,
    maxLevelValue = 5
) {
