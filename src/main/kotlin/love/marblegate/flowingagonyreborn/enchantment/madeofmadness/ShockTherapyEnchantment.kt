...
object ShockTherapyEnchantment : ModBaseEnchantment(
    ...
    tradableSetting = EnchantmentConfig.tradableConfig.shockTherapy,
    discoverableSetting = EnchantmentConfig.discoverableConfig.shockTherapy,
    canApplyOnEnchantingTableSetting = EnchantmentConfig.applyOnEnchantingTableConfig.shockTherapy,
    isTreasureOnlySettings = EnchantmentConfig.isTreasureConfig.shockTherapy,
    canEnchantSetting = EnchantmentConfig.canEnchantConfig.shockTherapy,
    maxLevelValue = 3
) {
