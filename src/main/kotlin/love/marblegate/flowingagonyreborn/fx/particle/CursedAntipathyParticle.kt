...
class CursedAntipathyParticle : TextureSheetParticle {
    constructor(world: ClientLevel, x: Double, y: Double, z: Double, diameter: Float) : super(world, x, y, z) {
        lifetime = 100
    ...
    class Factory(private val spriteSet: SpriteSet) : ParticleProvider<CursedAntipathyParticleOption> {
        override fun createParticle(typeIn: CursedAntipathyParticleOption, worldIn: ClientLevel, x: Double, y: Double, z: Double, xSpeed: Double, ySpeed: Double, zSpeed: Double): Particle {
