...
object
ShockTherapyImplicitEffect : HarmfulBlankImplicitEffect() {
    override fun applyEffectTick(pLivingEntity: LivingEntity, pAmplifier: Int) {
        ...
        pLivingEntity.hurt(DamageSource.LIGHTNING_BOLT.bypassArmor(), (pLivingEntity.random.nextInt(3) + 2).toFloat())
    }
