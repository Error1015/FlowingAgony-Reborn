    ...
    override fun initializeClient(consumer: Consumer<IClientMobEffectExtensions?>) {
        consumer.accept(object : IClientMobEffectExtensions {
            ...
            override fun renderInventoryIcon(
                instance: MobEffectInstance?, screen: EffectRenderingInventoryScreen<*>?, poseStack: PoseStack?, x: Int, y: Int, blitOffset: Int
            ) = false
            ...
            override fun renderGuiIcon(
                instance: MobEffectInstance?, gui: Gui?, poseStack: PoseStack?, x: Int, y: Int, z: Float, alpha: Float
            ) = false
        })
    }
}