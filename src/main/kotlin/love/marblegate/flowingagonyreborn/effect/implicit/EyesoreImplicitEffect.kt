...
object EyesoreImplicitEffect : ImplicitBaseEffect() {
    override fun applyEffectTick(entity: LivingEntity, amplifier: Int) {
        entity.level.explode(entity, entity.x, entity.y, entity.z, 1f, Explosion.BlockInteraction.NONE)
        entity.hurt(DamageSource.explosion(entity), (3 + amplifier * 2).toFloat())
    ...
    override fun isDurationEffectTick(duration: Int, amplifier: Int) = duration == 1
}